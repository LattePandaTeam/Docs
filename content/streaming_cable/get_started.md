...
1. Unlicensed Windows: Click to download [SetupEnv_NM](/assets/streaming_cable_resources/SetupEnv_NM)，Right-click and select Run as administrator, after running, it will close automatically
