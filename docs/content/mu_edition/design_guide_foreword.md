...
The carrier board design involves high-frequency signals such as **HDMI 2.1, USB 3.2 (10Gbps), and PCIe 3.0**. Signal integrity is paramount.
...
- **Length Matching**: Strict length matching is crucial to minimize skew. Accurate **intra-pair length matching** for differential signals (P/N traces) is mandatory to maintain phase alignment.

## Reading Recommendations

- To better understand the circuit details, we strongly recommend reading this guide alongside the engineering documents (Schematic & PCB) of the open-source [**DFR1142 Lite Carrier Board**](https://github.com/LattePandaTeam/LattePanda-Mu/tree/main/Electricals/Examples).
